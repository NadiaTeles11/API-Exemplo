...
using NexcodeControls.Domain.Queries.Entidade;
using NexcodeControls.Domain.Repositories.Entidade;
using System;
using System.Linq;

namespace NexcodeControls.Data.Repositories.Entidade
{
    public class EmpresaRepository : IEmpresaRepository
    {
        private readonly Context.NexcodeControlsContext _context;

        public EmpresaRepository(Context.NexcodeControlsContext context)
        {
            _context = context;
        }
